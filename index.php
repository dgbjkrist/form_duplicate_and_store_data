...
<html>  
    ...
    <body>
        <div class="container">
			...
			<br />
			<input type="text" name="capital" id="capital" onblur="getCapital(this.value)">
			<br />
		...
		<div id="user_dialog" title="Add Data">
			...
			<div class="form-group">
				...
				<input type="number" name="last_name" id="last_name" class="form-control" min="0" />
...
$(document).ready(function(){ 
	...
	$('#save').click(function(){
		...
		else
		{
			...
			if($('#save').text() == 'Save')
			{
					montant= montant + parseInt(last_name);
					console.log(montant);
				count = count + 1;
				...
				output += '<td>'+last_name+' <input type="hidden" name="hidden_last_name[]" id="last_name'+count+'" value="'+last_name+'" onblur="getlasmontant(this.value)" /></td>';
